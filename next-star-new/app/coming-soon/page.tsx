...
export default function ComingSoonPage() {
  return (
    <main className={styles.comingSoonPage}>
      <Hero
        title="Coming Soon - Gallery Page"
        text="Next Star Dance Competition gallery page is sadly under construction. We're preparing something exciting! Stay tuned and be the first to know."
      />
